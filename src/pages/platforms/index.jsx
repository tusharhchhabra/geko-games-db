...
const PlatformsGameList = ({
  ...
  return (
    <div className="p-10 w-full">
      ...
      {loading && (
        <div role="status" className="fixed inset-x-0 bottom-0 flex justify-center">
        <svg aria-hidden="true" className="w-11 h-11 text-gray-200 animate-spin dark:text-gray-600 fill-violet-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
