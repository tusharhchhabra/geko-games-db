  ...
  return (
    <div>
      {gamesFetched ? (
        ...
        <div className="text-violet-500 font-bold text-xl [text-shadow:2px_2px_3px_var(--tw-shadow-color)] shadow-black ">Loading Favourites...</div>
      )}
      {!fullGptGamesFetched && gamesFetched && (
        <div role="status" className="fixed absolute bottom-5 left-[850px] flex justify-center">
        <svg aria-hidden="true" class="w-11 h-11 text-gray-200 animate-spin dark:text-gray-600 fill-violet-500" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="absolute bottom-2.5 left-14 text-violet-500 font-bold text-xl [text-shadow:2px_2px_3px_var(--tw-shadow-color)] shadow-black w-[200px]">Our AI is thinking...</p>
    </div>
      )}
